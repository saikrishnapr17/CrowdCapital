...
function Investments({ onNavigate, userId }) {
            ...
            tooltip: {
              callbacks: {
                label: function(context) {
                  ...
                  const total = business.goal || 1; // Prevent division by zero
  ...
  const handleCancelInvest = () => {
    ...
    setInvestmentAmount('');
    if (selectedBusiness) {
      const businessToReload = businesses.find(b => b.business_id === selectedBusiness.business_id);
      if (businessToReload) {
        setSelectedBusiness(businessToReload);
      }
    }
  };
      ...
      {selectedBusiness !== null && investingBusiness === null && (
        <div className="business-details-page">
          ...
          <div className="details-content">
            ...
            <p className="investment-goal">Investment Goal: ${selectedBusiness.goal?.toLocaleString() || 'N/A'}</p>
